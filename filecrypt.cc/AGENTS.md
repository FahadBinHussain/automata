...
> - **batch validation 2026-09-11 (26 public containers, agent-browser CDP): 5 unlocked with links** (B6B1F4A7B2 2x 6-12s, 10B07E0DCC 20s, BAE5E49853 9s, 8636EC546A 13s), 8 re-gated with valid submits (FCE74DF1E1 2x, 49D157238E 2x, 45FA709BED, CAA065F62D, 6B428F6B3A, DF668E63DB, 963DC89333, E6CCDE40BC, BCEAA33E12), 1 no-captcha passthrough (BFE9C5C21F). **rejected submits had valid nonces (verified lz>=diff), clean pow_x `[[605]]`, full pow_data — cause unknown.** rejected ≠ dead links (ABE64FB6DB "unlocked" with zero links was transient unload, re-gated on revisit). unlock check now requires links present, not just `cap=false`.
> - **throttle: IP gets 429 + hanging y-host/session requests after ~8 rapid submits.** pace submits ≥3-5 min apart for validation; rapid batches pollute results (re-gates indistinguishable from throttle-rejects). batch stopped 2026-09-11 09:2x UTC when challenges stopped arriving (90s no-challenge).
