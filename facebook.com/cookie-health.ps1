...
#
# Neon usage watcher: REMOVED 2026-08-23. lumen now runs its own neon_usage
# watcher (internal/notify, enabled in config/production.yaml) - the bundled
# hourly neon-hours-table.ps1 check here was the murmur-parity interim and
# became redundant once lumen took over. this script is FB cookie health only.
...
# holds MURMUR_HF_SPACE_URL, HF_EMAIL, etc.
...
# ── Neon usage watcher REMOVED 2026-08-23 ───────────────────────────────────
# lumen now runs its own neon_usage watcher (internal/notify/neonusage.go,
# enabled in config/production.yaml). the bundled hourly neon check that used
# to live here (neon-hours-table.ps1 -Json -> bridge notification) was the
# murmur-parity interim and became redundant once lumen took over. this script
# is FB cookie health only.
